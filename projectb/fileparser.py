    ...
    with open(file,"r") as f:
        for line in f:
            ...
            if(params.has_key(param)):
                ...
                if param == "bounds":
                    ...
                    if splitline[1] in objectives:
                        ...
                        if console is not None:
                            ...
                            raise ValueError(("The objective "+splitline[1] +" does not exist, please check the file"))
                elif(param=="solver"):
                    ...
                    if splitline[1] in initializers:
                        ...
                        if console is not None:
                            ...
                            raise ValueError(("The initializer "+splitline[1] +" does not exist, please check the file"))
                    ...
                    if splitline[1] in recommenders:
                        ...
                        if console is not None:
                            ...
                            raise ValueError(("The recommender "+splitline[1] +" does not exist, please check the file"))
                elif(param=="policies"):
                    for policy in splitline[1:]:
                        if policy in policies:
                            ...
                            if console is not None:
                                ...
                                raise ValueError(("The policy values "+policy +" does not exist, please check the file"))
                elif(param=="kernels"):
                    for kernel in splitline[1:]:
                        if kernel in kernels:
                            ...
                            if console is not None:
                                ...
                                raise ValueError(("The kernel values "+kernel +" does not exist, please check the file"))
                elif(param=="data"):
                    params["data"] = [[],[]]
                    if splitline[1] is not None:
                        if os.path.isfile(splitline[1]):
                            ...
                            if console is not None:
                                ...
                                raise ValueError("The "+splitline[1] +" data file does not exists, check the file URI")
                ...
                raise ValueError(('The parameter ' + param + " does not exists, please check the parameter name syntax" ))
...
def parsemodifycustomvar(customvarsparam, simpleparams):
    ...
    for (key,value) in customvarsparam.items():
        if key == "policies":
            ...
            if (simpleparams[key]).lower() =="true":
