...
def main(argv):
    ...
    parser.add_argument("-v", "--verbosity", type=int, choices=[0, 1, 2],default=0, help="increase output verbosity, 1 will inform of only about experiment start and finish. 2 will inform of each iteration")
    ...
    try:
        ...
        parser.error("You do not have all the necessary libraries installed. ProjectB requires following libraries to work pybo, pygp, numpy. For the Graphical"
    ...
    if args.cli:
        ...
        bayesianthreadcli.BayesianOptProcess(fileparser.parsein(args.paramfile,defaultparams,console),console=console)
    else:
        try:
            import Tkinter
            import matplotlib
        except:
            parser.error("For the Graphical User Interace you must have Tkinker module and Matplot library. Please refer to the online documentation for more information.")
